...
const VturbSmartplayer = (props: React.HTMLAttributes<HTMLElement>) =>
  React.createElement("vturb-smartplayer", props as any);
import logo from "../assets/zeyra-logo-no-bg.png";
import logoSamsung from "../assets/logo-samsung.png";
import FloatingWhatsApp from "../components/FloatingWhatsApp";

const ZeyraLanding: React.FC = () => {
  useEffect(() => {
    ...
    // Vturb Smartplayer script
    ensureScript(
      "https://scripts.converteai.net/aa502a47-4689-4efc-b5e2-97944963d2cd/players/68c8c1a66a34513543d1875a/v4/player.js"
    );

    // Sistema de fontes profissional com Google Fonts
    ...
    const buttonHandlers = clickableButtons.map((btn) => {
      const handler = () => {
        ...
        btn.innerHTML = `<span class="loading-animation"></span> Processando...`;
  ...
  return (
    <div className=" overflow-x-hidden">
      ...
      <style>{`
        ...
        .video-title{font-family:var(--font-display)!important;}
        ...
        .demo-video-container{position:relative;border-radius:12px;overflow:hidden;box-shadow:0 20px 40px rgba(0,0,0,0.3);margin:40px auto;max-width:900px;}
        .demo-video-overlay{position:absolute;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,0.5);display:flex;align-items:center;justify-content:center;opacity:1;transition:opacity .3s;}
        .demo-video-overlay:hover{opacity:.9;}
        .play-button{width:80px;height:80px;background:rgba(0,240,255,0.8);border-radius:50%;display:flex;align-items:center;justify-content:center;color:#000;font-size:30px;cursor:pointer;transition:all .3s;}
        .play-button:hover{transform:scale(1.1);background:rgba(0,240,255,1);}
        ...
        .video-section{margin-top:80px;margin-bottom:80px;}
        .video-title{font-size:2.5rem;margin-bottom:30px;text-align:center;}
        }
        @media (max-width:767px){.video-section{margin-top:40px;margin-bottom:40px;}
        .video-title{font-size:2rem;margin-bottom:20px;}
        ...
        .demo-video-container{margin:20px auto;}
        .video-title{font-size:1.8rem;}
        }
        @media (max-width:480px){.video-section{margin-top:30px;margin-bottom:30px;}
        .video-title{font-size:1.8rem;margin-bottom:16px;}
        ...
        .video-embed{position:relative;padding-bottom:56.25%;height:0;overflow:hidden;border-radius:12px;box-shadow:0 20px 40px rgba(0,0,0,0.3);}
      ...
      <div className="w-full flex flex-col relative z-10 scrollable-conten">
              ...
              <div className="relative max-w-6xl text-center">
                ...
                >
                  <span className="gradient-text">
                    Crie LeadPages em Qualquer Idioma
                  </span>
                  <br />
                ...
                <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto font-light">
                  A ZEYRA transforma sua ideia em um site profissional completo
                  em qualquer idioma, com hospedagem turbo e design moderno —
                  tudo feito automaticamente pela nossa inteligência artificial
                  multilíngue.
                </p>
                ...
                <div className="flex flex-col gap-2 sm:flex-row items-center sm:justify-between max-w-md mx-auto">
                  <div className="flex flex-col gap-2">
                    ...
                    <div className="flex items-center">
                      <i className="fas fa-check-circle text-primary mr-2"></i>
                      <span className="text-gray-300">Hospedagem Turbo</span>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <div className="flex items-center">
                      <i className="fas fa-check-circle text-primary mr-2"></i>
                      <span className="text-gray-300">Conteúdo Automático</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        {/* teste deploy */}
        <section id="video-demo" className="pb-8 py-4 px-6 lg:px-8">
          <div className="container mx-auto max-w-7xl">
            <h2 className="video-title font-bold font-display gradient-text text-center mb-6">
              Veja a ZEYRA em Ação
            </h2>
            <div className="w-full max-w-6xl mx-auto">
              <div className="w-full overflow-hidden rounded-lg shadow-2xl">
                <VturbSmartplayer
                  id="vid-68c8c1a66a34513543d1875a"
        ...
        <section className="trusted-by-section mt-6 ">
          <div className="container mx-auto">
            <h3 className="trusted-by-title">
              Confiança de negócios inovadores em todo o mundo
            </h3>
          ...
          <div className="container mx-auto">
            <div className="language-section">
              <h3 className="language-title">
                <i className="fas fa-globe-americas"></i> Suporte a +50 idiomas
              </h3>
              ...
              <div className="language-grid">
                ...
                <div className="language-item">
                  ...
                  <span className="language-name">E mais</span>
                </div>
              </div>
            </div>
          </div>
        ...
        >
          <div className="text-center mb-8">
            <h2 className="text-3xl md:text-4xl font-bold font-display mb-4">
              ...
              <span className="text-white">a ZEYRA?</span>
            </h2>
            <p className="text-xl text-gray-300 max-w-4xl mx-auto">
              Em apenas 4 passos simples, você terá um site profissional em
              qualquer idioma pronto para usar.
            </p>
          </div>
          ...
          <div className="flex gap-5 flex-wrap flex-col sm:flex-row items-center sm:justify-evenly  mx-auto">
            <div className="step-item w-full sm:max-w-[230px]">
              ...
              <p className="text-gray-300">
                Selecione um idioma para seu site. Nossa IA suporta mais de 50
                línguas diferentes.
              </p>
            </div>
            ...
            <div className="step-item w-full sm:max-w-[300px]">
              ...
              <p className="text-gray-300">
                Digite em linguagem simples o que você quer vender ou promover.
                A IA cria conteúdo e sugestões de imagens editáveis.
              </p>
            </div>
            ...
            <div className="step-item w-full sm:max-w-[300px]">
              ...
              <p className="text-gray-300">
                Em segundos, nossa inteligência artificial gera um site completo
                com design profissional em qualquer idioma desejado.
              </p>
            </div>
            ...
            <div className="step-item w-full sm:max-w-[280px]">
              ...
              <p className="text-gray-300">
                Adicione seu Domínio e seu site estará hospedado em nossa
                infraestrutura turbo. Basta publicar e começar a usar.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-8 px-4 lg:px-8 bg-gray-900/50">
          <div className="container mx-auto max-w-7xl">
            <h2 className="text-3xl md:text-4xl font-bold font-display mb-6 text-center">
              <span className="gradient-text">Sites Multilíngues</span>{" "}
              <span className="text-white">Feitos com IA</span>
            </h2>
              ...
              <div>
                ...
                <ul className="text-gray-300">
                  <li className="mb-3 flex items-start">
                    ...
                    <span>
                      Conteúdo gerado simultaneamente nos idiomas selecionados
                    </span>
                  </li>
                  <li className="mb-3 flex items-start">
                    <i className="fas fa-check-circle text-primary mr-2 mt-1"></i>
                    <span>Traduções contextualizadas para cada mercado</span>
                  </li>
                  <li className="mb-3 flex items-start">
                    <i className="fas fa-check-circle text-primary mr-2 mt-1"></i>
                    <span>
                      Suporte a mais de 50 idiomas incluindo português, inglês,
                      espanhol, francês, alemão, chinês e japonês
                    </span>
                  </li>
                  <li className="flex items-start">
                    <i className="fas fa-check-circle text-primary mr-2 mt-1"></i>
                    <span>
                      Interface moderna e intuitiva para editar e publicar suas
                      páginas
                    </span>
                  </li>
                </ul>
              ...
              <div>
                ...
                <ul className="text-gray-300">
                  <li className="mb-3 flex items-start">
                    <i className="fas fa-check-circle text-primary mr-2 mt-1"></i>
                    <span>
                      Com HTML pronto em um idioma específico, a IA traduz para
                      qualquer idioma sem precisar criar um novo site ou página
                    </span>
                  </li>
                  <li className="mb-3 flex items-start">
                    <i className="fas fa-check-circle text-primary mr-2 mt-1"></i>
                    <span>
                      Conteúdo adaptado e traduzido culturalmente para cada país
                      escolhido
                    </span>
                  </li>
                  <li className="mb-3 flex items-start">
                    <i className="fas fa-check-circle text-primary mr-2 mt-1"></i>
                    <span>
                      Não impõe limites culturais, políticos ou de gênero — você
                      escolhe o que comunicar ou vender
                    </span>
                  </li>
                  <li className="flex items-start">
                    <i className="fas fa-check-circle text-primary mr-2 mt-1"></i>
                    <span>Atualizações simultâneas em todas as versões</span>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="py-6 px-4 lg:px-8">
          <div className="container mx-auto max-w-7xl">
            <div className="text-center mb-8">
              <h2 className="text-3xl md:text-4xl font-bold font-display mb-4">
                <span className="gradient-text">Tudo o Que Você Precisa</span>{" "}
                <span className="text-white">em Uma Única Plataforma</span>
              </h2>
              <p className="text-xl text-gray-300 max-w-4xl mx-auto">
                Recursos poderosos para criar, editar e gerenciar seus sites em
                qualquer idioma sem complicação.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  desc: "Tenha seu site ou página de vendas profissional no ar em minutos com apenas uma descrição do seu negócio.",
                },
                {
                  icon: "fa-server",
                  title: "Hospedagem Turbo",
                  desc: "Seus sites já ficam hospedados em nossa infraestrutura de alta performance.",
                },
                {
                  icon: "fa-globe",
                  title: "Design Otimizado por IA",
                  desc: "Layouts modernos, responsivos e adaptados ao seu nicho. A inteligência artificial escolhe a estrutura que mais converte.",
                },
                {
                  icon: "fa-mobile-alt",
                  title: "Design Responsivo",
                  desc: "Layouts profissionais que se adaptam perfeitamente a qualquer dispositivo.",
                },
                {
                  icon: "fa-brain",
                  title: "Copywriting IA",
                  desc: "Seu site já nasce otimizado para o Google, com estrutura amigável para anúncios e estratégias de tráfego.",
                },
                {
                  icon: "fa-sync-alt",
                  title: "Atualização Simultânea",
                  desc: "Edite textos, imagens, cores e blocos com poucos cliques. Sem precisar saber programar.",
                },
                {
                  icon: "fa-user-shield",
                  title: "Independência Total",
                  desc: "Crie e edite seus sites quando quiser, sem depender de tradutores ou programadores.",
                },
                {
                  icon: "fa-rocket",
                  title: "Lançamento Rápido",
                  desc: "Esqueça prazos demorados. Com a Zeyra, seu site vai do zero ao online em tempo recorde.",
                },
              ].map((b, idx) => (
        ...
        >
          <div className="container mx-auto max-w-7xl">
            <div className="text-center mb-8">
              ...
              <p className="text-xl text-gray-300 max-w-4xl mx-auto">
                Planos acessíveis para todos os tamanhos de negócio. Comece hoje
                mesmo.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              ...
              <div className="price-card cyber-glass cyber-border font-extralight p-8 rounded-2xl">
                ...
                <ul className="space-y-3 mb-8">
                  {/* <li className="flex items-center">
                    <i className="fas fa-check-circle text-primary mr-2"></i>
                    <span>1 Hospedagem de Dominio </span>
                  </li> */}
                  <li className="flex items-center">
                    <i className="fas fa-check-circle text-primary mr-2"></i>
                    <span>Até 2 idiomas</span>
                  </li>
                  <li className="flex items-center">
                    <i className="fas fa-check-circle text-primary mr-2"></i>
                  ...
                  {/* <li className="flex items-center">
                    <i className="fas fa-check-circle text-primary mr-2"></i>
                    <span>Hospedagem Basica</span>
                  </li> */}
                  <li className="flex items-center">
                    <i className="fas fa-check-circle text-primary mr-2"></i>
                    <span>Até 10 mil visitas/mês</span>
                  </li>
                ...
                <a href="https://payment.ticto.app/O6905784E" target="_blank">
              ...
              <div className="price-card cyber-glass cyber-border p-8 rounded-2xl font-extralight popular">
                ...
                <p className="text-gray-400 mb-6">
                  Ideal para negócios digitais
                </p>
                <div className="mb-6">
                  <span className="text-4xl font-bold text-white">R$69,99</span>{" "}
                  <span className="text-gray-400">/mês</span>
                </div>
                <ul className="space-y-3 mb-8">
                  {/* <li className="flex items-center">
                    <i className="fas fa-check-circle text-primary mr-2"></i>
                    <span>3 Hospedagem de Dominio</span>
                  </li> */}
                  <li className="flex items-center">
                    <i className="fas fa-check-circle text-primary mr-2"></i>
                    <span>Até 5 idiomas</span>
                  </li>
                  <li className="flex items-center">
                    <i className="fas fa-check-circle text-primary mr-2"></i>
                  ...
                  <li className="flex items-center">
                    <i className="fas fa-check-circle text-primary mr-2"></i>
                    <span>Até 100 mil visitas/mês</span>
                  </li>
                </ul>
                <a href="https://payment.ticto.app/O6EEDA811" target="_blank">
              ...
              <div className="price-card cyber-glass cyber-border font-extralight p-8 rounded-2xl">
                ...
                <p className="text-gray-400 mb-6">
                  Para agências e grandes negócios
                </p>
                <div className="mb-6">
                ...
                <ul className="space-y-3 mb-8">
                  ...
                  <li className="flex items-center">
                    <i className="fas fa-check-circle text-primary mr-2"></i>
                    <span>Até 1 milhão de visitas/mês</span>
                  </li>
                ...
                <a href="https://payment.ticto.app/O39902A4F" target="_blank">
          ...
          <div className="container mx-auto max-w-7xl text-center">
            <div className="max-w-5xl mx-auto">
              <h2 className="text-3xl md:text-4xl font-bold font-display mb-6">
                ...
                <span className="text-white">em Vários Idiomas?</span>
              </h2>
              <p className="text-xl text-gray-300 mb-6">
                Não perca tempo com tradutores e desenvolvedores. Deixe nossa IA
                criar seu site profissional em qualquer idioma hoje mesmo.
              </p>
              <div className="flex flex-wrap justify-center gap-4">
                <a href="#pricing" className="modern-btn">
                  <i className="fas fa-bolt"></i> Quero Meu Site Agora
                </a>
              </div>
              <div className="mt-6 text-sm text-gray-400 flex items-center justify-center">
                <i className="fas fa-lock mr-2"></i> Compra 100% segura • 7 dias
                de garantia
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto max-w-7xl">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div className="md:col-span-2">
                ...
                <p className="text-gray-400 mb-6">
                  A plataforma mais avançada para criação de sites multilíngues
            ...
            <div className="border-t border-gray-800 mt-8 pt-8 text-center">
              <p className="text-gray-500 text-sm">
                © 2025 ZEYRA. Todos os direitos reservados.
              </p>
            </div>
          </div>
        </footer>
